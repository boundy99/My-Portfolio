  ...
  return (
    ...
    >
      ...
      <Typography variant="inherit" sx={{ pt: '18px', pb: '50px' }}>
        ...
        and Unity to teach linked list data structures. I have a wide range of
        technical skills, including programming languages such as C++, Java, C#,
        and Python, as well as frameworks and technologies like React, Node.js,
        and Unity.
      </Typography>
    </Container>
  );
